<?php include(APPPATH . 'Views/layout/header.php'); ?>
    ...
    <div class="text-start">
        <p>LuckScape(이하 "회사" 또는 "운세 서비스")는 사용자의 개인정보를 중요하게 생각하며, 다음과 같이 개인정보 처리 방침을 안내드립니다.</p>
        <p></p>
        <h5>1. 수집하는 개인정보 항목 및 수집 방법</h5>
        ...
        <h5>5. 개인정보 보호를 위한 기술적·관리적 조치</h5>
